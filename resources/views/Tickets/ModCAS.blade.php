	...
	<div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Nuevo Ticket (CAS Brother)</h4>
            </div>
                            ...
                            <div class="{{ $errors->has('categoria_id') ? ' has-error' : ''}}">
                                ...
                                <div class="col-sm-12">
                                    <select style="border-color: rgba(107, 107, 107, 0.527)" class="custom-select custom-select-sm" name="categoria_id" id="categoria_id" >
                                        <option value="5">CAS Brother</option>
                                    </select>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="{{ $errors->has('cas_compra') ? ' has-error' : ''}}">
                                ...
                                <div class="col-sm-12">
                                    <input style="border-color: rgba(107, 107, 107, 0.527)" type="date" id="cas_compra" name="cas_compra" class="form-control form-control-sm datepicker">
                                </div>
