<div id="ModTar" class="modal fade" data-backdrop="static" tabindex="-1">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group{{ $errors->has('agente_id') ? ' has-error' : ''}}">
                                <label class="col-sm-2 col-form-label" for="nombre">Agente</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group{{ $errors->has('descripcion') ? ' has-error' : ''}}">
                                ...
                                <div class="col-sm-12">
                                    <input style="border-color: rgba(107, 107, 107, 0.527)" type="text" class="form-control form-control-sm" id="descripcion" name="descripcion">
                                </div>
                            ...
                            <div class="form-group{{ $errors->has('estado') ? ' has-error' : ''}}">
                                <label class="col-sm-12 col-form-label" for="estado">Estatus</label>
                                <div class="col-sm-12">
