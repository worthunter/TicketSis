                    ...
                    <div class="row card-body">
                        <div class="col">
                            <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control" value="{{ $agentes->nombre }}">
                            ...
                            <div class="form-group{{ $errors->has('apellido') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="apellido" id="apellido" class="form-control " value="{{ $agentes->apellido }}">
                            ...
                            <div class="form-group{{ $errors->has('correo') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="correo" id="correo" class="form-control " value="{{ $agentes->correo }}"><hr>
                            ...
                            <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="telefono" id="telefono" class="form-control " value="{{ $agentes->telefono }}">
                            ...
                            <div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="direccion" id="direccion" class="form-control " value="{{ $agentes->direccion }}">
                        ...
                        <div class="col">
                            <div class="form-group{{ $errors->has('municipio') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="municipio" id="municipio" class="form-control " value="{{ $agentes->municipio }}">
                            ...
                            <div class="form-group{{ $errors->has('entidad') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="entidad" id="entidad" class="form-control" value="{{ $agentes->entidad }}">
                            ...
                            <div class="form-group{{ $errors->has('rfc') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="rfc" id="rfc" class="form-control" value="{{ $agentes->rfc }}">
                                @if ($errors->has('rfc'))
                                    <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('departamento') ? ' has-error' : '' }} form-inline">
                                ...
                                <input type="text" name="departamento" id="departamento" class="form-control" value="{{ $agentes->departamento }}">
